...
function send_email($email, $subject, $body, $from = 'a.shriedi@tsol-sa.com') {
    ...
    $config = Array(
        ...
        'smtp_port' => 465,
        'smtp_user' => 'a.shriedi@tsol-sa.com',
        'smtp_pass' => 'XCBNM679tr',
        'mailtype' => 'html',
    );

    $CI->email->from($from, 'T-Solutions');
    $CI->email->to($email);
    $CI->email->reply_to($from, 'T-Solutions');
    ...
    <div>        
            ...
            <div style="width: 600px; height: 30px;">
                <span style="font-size: 11px;color: #404040;padding-left: 200px;padding-top: 2px;
                      display: inline-block; margin-top: 5px;">All rights reserved &copy; T-Solutions ' . date('Y') . '</span>
            </div>
        </body></html>';
