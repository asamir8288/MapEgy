...
class Home extends CI_Controller {
    ...
    public function index() {        
        ...
        $this->data['activeNews'] = NewsTable::getActiveNews(5, '', TRUE, $this->data['lang_id']);
        $this->data['newsCount'] = NewsTable::getNewsCount($this->data['lang_id']);
        $this->data['active_events'] = EventsTable::getActiveEvents(3, $this->data['lang_id']);
        $this->data['activeBanners'] = BannersTable::getActiveBanners(1, TRUE, 'ASC', FALSE, $this->data['lang_id']);
