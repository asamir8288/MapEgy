...
Doctrine_Manager::getInstance()->bindComponent('Careers', 'default');
 ...
 */
abstract class BaseCareers extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('careers');
        ...
        $this->hasColumn('active_flag', 'integer', 1, array(
             'type' => 'integer',
             'length' => 1,
             'fixed' => false,
             'unsigned' => false,
